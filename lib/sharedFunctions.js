...
addAndRemovePointsForUsers = function(winner, looser, pointsForTheWinner, pointsForTheLooser, championshipOrTournament, championshipOrTournamentId) {
	...
	if (championshipOrTournament === 'championship') {
		Meteor.call('addPointsForPlayerInChampionship', championshipOrTournamentId, winner, pointsForTheWinner);
		Meteor.call('addPointsForPlayerInChampionship', championshipOrTournamentId, looser, pointsForTheLooser);
	} else if (championshipOrTournament === 'tournament') {
		Meteor.call('addPointsForPlayerInTournament', championshipOrTournamentId, winner, pointsForTheWinner);
		Meteor.call('addPointsForPlayerInTournament', championshipOrTournamentId, looser, pointsForTheLooser);
	} else {
