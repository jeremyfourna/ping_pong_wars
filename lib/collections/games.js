	...
	addAGame: function(gameData) {
		...
		if (lastPoints1 - lastPoints2 < 400 && lastPoints2 - lastPoints1 > -400) {
			if (winner() === gameData.player1) {
				...
				pointsToLoose = Math.round(lastPoints2 + pointBase(player2Infos.profile.points.length, lastPoints2) * (0 - 1 / (1 + Math.pow(10, (lastPoints2 - lastPoints1) / 400))));
				...
				pointsToAdd = Math.round(lastPoints2 + pointBase(player2Infos.profile.points.length, lastPoints2) * (1 - 1 / (1 + Math.pow(10, (lastPoints2 - lastPoints1) / 400))));
